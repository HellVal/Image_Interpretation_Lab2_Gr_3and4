...
def train_model(model, dataloaders, criterion, optimizer, num_epochs, log_path):
    ...
    for epoch in range(1, num_epochs+1):
        ...
        for phase in ['train', 'valid']:
            ...
            # print("len: {}, minus: {}, len-minus: {}, plus: {}".format(len(dataloaders[phase].dataset), counter_minus, len(dataloaders[phase].dataset) - counter_minus, counter_plus))
            epoch_loss = running_loss / (len(dataloaders[phase].dataset) - counter_minus)
