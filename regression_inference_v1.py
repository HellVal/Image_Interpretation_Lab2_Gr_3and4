...
import server_train_data_loader_yatao_new
from random import randint
os.environ["KMP_DUPLICATE_LIB_OK"] = "TRUE"


if __name__ == '__main__':
    root = r'C:\ETH Course\Image interpretation\Regression\New_result_2\data'
    # root = '../lab_2_data'
    trained_model_name = 'v1.0/model_fcn_resnet50_best'

    # dataset and some basic variables
    dataTest = root + '/test_data.hdf5'
    test_dataset = server_train_data_loader_yatao_new.ImageLoader(windowsize=256, test=False, datafile=dataTest, _num_smpls=2)
    ...
    f_error = open(root + '/error_result.txt', 'w')
    f_error.write("RMSE: {}\n".format(_rmse))
    f_error.write("MAE: {}\n".format(_mae))
    f_error.write("Mean: {}\n".format(_ave))
    f_error.write("Max: {}\n".format(_max))
