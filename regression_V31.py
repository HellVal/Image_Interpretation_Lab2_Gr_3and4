        ...
        for phase in ['train', 'valid']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    loss = criterion(outputs['out'], labels.unsqueeze(1))  # expand the dimension of label to 4
...
if __name__ == '__main__':
    ...
    dataset = train_data_loader.ImageLoader(windowsize=256, test=False, datafile=dataTraining)
